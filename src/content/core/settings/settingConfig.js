    ...
    Marketplace: {
        ...
        settings: {
            ...
            marketplace3DRenderEnabled: {
                ...
                experimental:
                    'This feature may cause performance issues or bugs.',
            },
    ...
    transactions: {
        ...
        settings: {
            robuxFiatEstimatesEnabled: {
                ...
                experimental:
                    'Sometimes shows the wrong amount, and may causes some issues on the site.',
                childSettings: {
        ...
        settings: {
            bandurationsEnabled: {
                ...
                description: [
                    ...
                    '- Banned',
                    'Old moderation durations:',
                    'Note: Account Terminated replaced Account Deleted in April 2025'
                    '- Warning',
                    '- Banned for 1 Hour',
                    '- Banned for 6 Hours',
                    '- Banned for 1 Day',
                    ...
                    '- Account Deleted',
                    '- Account Terminated',
                    'Unused moderation durations:',
                    '- Banned for 2 Days',
                    '- Banned for 3 Hours',
                    '- Banned for 12 Hours',
                    "• Note: the following are not bans, but instead Roblox informing you what will happen if you break the rules again.",
                    "• This following is known as a 'Forshadow ban', it was used on some bans from between August 2024 and sometime in early 2025.",
            ...
            BanReasons: {
                ...
                description: [
                    ...
                    '• Inappropriate (Old)',
                    '• Privacy (Old)',
                    '• Unclassified Mild (Unused)',
                    '• BlockedContent',
                    '• Minor Swearing (Unused)',
                    '• Distorted Audio',
                    '• Loud Earbleeders (Unused)',
                    '• Players Screaming into Microphone (Unused)',
                    '• Swearing',
                    '• P####graphic Sounds (Unused)',
                    '• Explicit S##ual References and Innuendo (Unused)',
                    '• Dr## and Alc###l References (Unused)',
                    '• Discriminatory or N##i Content (Unused)',
                    '• Dating Imagery (Unused)',
                    '• Discriminatory Content',
                    '• Dr##s, Alc###l (Unused)',
                    '• DMCA (Unused)',
                    '• Explicit N####y/P##n (Unused)',
                    '• Gang Images (Unused)',
                    '• N###s (Unused)',
                    '• Personal Attack/Harassment/Bullying (Old)',
                    '• Red Armbands (Not N###s) (Unused)',
                    '• Suggestive/S##ualized Imagery (Unused)',
                    '• S####de/Self-####',
                    '• Clickbait Ads (Unused)',
                    '• Inappropriate Content (Unused)',
                    '• Not Related to Roblox (Unused)',
                    '• Off-Site Links (Unused)',
                    '• Hidden Message Clothing (Unused)',
                    '• None of the Above (Unused)',
                    '• Account Theft',
                    '• Asset Ownership',
                    '• Billing',
                    '• Compromised Account',
                    '• Copyright/DMCA (Unused)',
                    '• Derogatory/Harassment (Unused)',
                    '• Depressive (Unused)',
                    '• Discriminatory (Old)',
                    '• Exploiting (Unused)',
                    '• Text Filter / Profanity (Unused)',
                    '• Gr###ing (Unused)',
                    '• Illicit Substance (Unused)',
                    '• Malicious (Unused)',
                    '• Misleading (Unused)',
                    '• Dating',
                    '• Phishing/Scam (Unused)',
                    '• Real Info (Unused)',
                    '• RMT (Note: Real money transaction) (Unused)',
                    '• S##ual/Adult Content (Unused)',
                    '• Shock (Unused)',
                    '• Threats (Unused)',
                    '• Real-Life Tragedy',
                    '• Politics (Unused)',
                    '• Encouraging Dangerous Behavior (Unused)',
                    '• Other',
                    '• Dating and Romantic Content (Old)',
                    '• S##ual Content',
                    ...
                    '• Political Content (Old)',
                    '• T###orism/Extremism',
                    '• Child Endangerment (Old)',
                    '• Real-Life Threats',
                    '• Cheat and Exploits',
                    '• Seeking S##ual Content (Unused)',
                    '• Disruptive Audio',
                    ...
                    '• Off Platform Speech and Behavior (Unused)',
                    '• Violent Content and Gore',
                    '• Advertising',
                    '• Chargeback',
                    '• DMCA Early Legal Strike (Unused)',
                    '• DMCA Final Legal Strike (Unused)',
                    '• Child Ex#########n
                    '• You created or used an account to avoid an enforcement action taken against another account (Note: This is not a ban reason; this is a moderator note)',
                    '• This account is linked to an account (@account) banned for a severe violation of our Community Standards. Only the banned account can appeal that violation. If the two accounts shouldn\'t be linked to each other, send an appeal using this account from Violations & Appeals. (Note: This is not a ban reason; this is a moderator note)',
                    '• Trademark Violation',
